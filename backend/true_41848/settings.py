"""
Django settings for true_41848 project.
...
WSGI_APPLICATION = 'true_41848.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "true_41848 API",
    "DESCRIPTION": "API documentation for true_41848 App",
    "VERSION": "v1",
}
